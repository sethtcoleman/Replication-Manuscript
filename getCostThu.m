function [cost, err_mat] = getCostThu(tm1, ym1, PCR, V, convFac, ...
    i_taus, normWeight)
%Calculates the error in Thu's <MOI> ~ 1 qPCR experiment
...
for j = transpose(taus)
    err_mat(scaled_index) = ...
        normWeight(scaled_index)*( ym1(j, end)*V(j)/convFac - ...
