...
%v2: Now the normalization matrix completely defines the weighting. Also
%changes err_mat to have a column for each t-point.
%v3: MOI 1:5 now fitted
%v4: does not fit pts with only 1 cell
